...
import { mapVariantImageByColor } from "@/src/app/store/_components/utils/product-card-utils";
import { ColorHoverSwatches } from "@/src/app/store/_components/ColorHoverSwatches";
...
export default function ProductCard({ product }: ProductCardProps) {
  ...
  const variantImageByColor = useMemo(
    () => mapVariantImageByColor(product),
    [product],
  );
